...
export default function Login() {
  ...
  return (
    ...
    <>
<h1 className="text-center text-5xl font-bold py-10">Login Form</h1>
    ...
    <Input 
     register={register}
      registerValue={'username'} 
       errors={errors}
      className="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 text-black-900 focus:text-black-900"
    />
  </div>
